...
export interface Dictionary {
  ...
  landing: {
    ...
    demoTitle: string;
    demoSubtitle: string;
    demoScriptLabel: string;
    demoScriptSample: string;
    demoCharCount: string;
    demoPreviewLabel: string;
    demoPreviewTitle: string;
    demoWaitingBadge: string;
    ...
    apiTitle: string;
    apiSubtitle: string;
    apiExploreButton: string;
    apiDocsButton: string;
    apiNote: string;
    faqEyebrow: string;
    faqTitle: string;
    faqSubtitle: string;
