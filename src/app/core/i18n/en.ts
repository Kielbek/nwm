...
export const en: Dictionary = {
  ...
  editor: {
    ...
    regenerate: 'Generate speech again',
    errorNoSpeechEngine: 'The speech engine is unavailable in this browser.',
    importFile: 'Import file',
    fileImportError: "Couldn't read that file. Text files (.txt) are supported.",
    fileTruncated: 'The file was longer than the limit — the text was truncated.',
    charactersRemaining: '{n} characters left on your plan',
  },
  player: {
    thumbUp: 'Helpful',
  ...
  profilePage: {
    ...
    verifyEmailPrompt: 'Verify your email',
    ...
    statsUseFavoriteVoice: 'Create with this voice',
  ...
  settingsPage: {
    ...
    dangerSubtitle: 'These actions affect your current session — proceed with caution.',
    resetLabel: 'Sign out of all devices',
    resetDesc: 'End your session here and on every other device you are signed in on.',
    resetButton: 'Sign out everywhere',
    resetConfirmTitle: 'Sign out everywhere?',
    resetConfirmBody:
      "You'll be signed out of this device and every other device you're currently signed in on. You'll need to sign in again.",
    resetConfirmAction: 'Yes, sign out',
    resetCancelAction: 'Cancel',
    resetDone: 'Signed out of all devices.',
    saved: 'Changes saved.',
    securityTitle: 'Security',
    securitySubtitle: 'Manage your password and two-factor verification.',
    securityDemoNote: "To change your password, we'll email you a reset link.",
    currentPasswordLabel: 'Current password',
    newPasswordLabel: 'New password',
    confirmPasswordLabel: 'Confirm new password',
    changePasswordButton: 'Send password reset link',
  ...
  fileManager: {
    title: 'Your files',
    subtitle: 'Organize your generated recordings into folders.',
    allFiles: 'All files',
    ...
    confirmDeleteFolderTitle: 'Delete this folder?',
    confirmDeleteFolderBody: "Recordings inside won't be deleted — they'll move back to \"All files\".",
    confirmDeleteFolderAction: 'Yes, delete it',
    itemCount: '{n} recordings',
    emptyFolders: "You don't have any folders yet.",
    emptyRoot: "You haven't generated any speech yet.",
    emptyRootHint: 'Generated speech will show up here automatically.',
  ...
  landing: {
    ...
    fieldStyleValue: 'Natural',
    readyToGenerate: 'Ready to generate',
    trustStripTitle: 'Built for creators, developers, and businesses.',
    ...
    demoEyebrow: 'Try the signal',
    demoTitle: 'Hear it for yourself.',
    demoSubtitle: 'Write a line, find its mood, and let the studio do the rest.',
    demoScriptLabel: 'Your script',
    demoScriptSample: 'The best ideas deserve to be heard.',
    demoCharCount: '{n} / 1000 characters',
    demoPreviewLabel: 'Local preview',
    demoPreviewTitle: 'Your sound lives here.',
    demoWaitingBadge: 'Waiting',
    ...
    apiEyebrow: 'For builders',
    apiTitle: 'Look under the hood.',
    apiSubtitle: "This is the request our own app sends to turn text into speech.",
    apiExploreButton: 'See the docs',
    apiDocsButton: 'Go to documentation',
    apiNote: "Today this endpoint only serves the NWM web app — a public API for your own integrations is on our roadmap.",
  ...
  authLayout: {
    tagline: 'Your voice, in every language.',
    taglineLogin: 'Welcome back. Your voices are waiting.',
    taglineRegister: 'Join and start generating speech in seconds.',
    point1: '40+ natural-sounding voices',
    point2: 'Generate speech in seconds',
    point3: 'No card required on the free plan',
  ...
  loginPage: {
    ...
    errorLocked: 'Account temporarily locked after too many failed attempts. Try again in a few minutes.',
  ...
  registerPage: {
    ...
    subtitle: 'Start generating speech from text for free, no card needed.',
    googleButton: 'Continue with Google',
    divider: 'or',
    nameLabel: 'Full name',
    ...
    errorPasswordTooShort: 'Password must be at least 10 characters.',
    errorPasswordMismatch: 'Passwords do not match.',
    errorAccountExists: 'An account with that email already exists.',
    errorValidation: 'Please check the details you entered.',
    errorRateLimited: 'Too many attempts. Please wait a moment and try again.',
    errorUnknown: 'Something went wrong. Please try again.',
  ...
  forgotPasswordPage: {
    ...
    sentBody: "If an account with {email} exists, we've sent a password reset link to it.",
  ...
  resetPasswordPage: {
    ...
    doneBody: 'You can now sign in with your new password. We signed out every other device for your security.',
    goToLogin: 'Go to sign in',
    missingTokenTitle: 'Missing reset token',
    missingTokenBody: 'This link is invalid. Request a new password reset link.',
    requestNewLink: 'Request a new link',
  },
  verifyEmailPage: {
    title: 'Email verification',
    checkingTitle: 'Verifying your email address…',
    successTitle: 'Email address confirmed',
    successBody: 'Thanks! Your email address has been successfully verified.',
    errorTitle: 'Verification failed',
    errorBody: 'This link is invalid or has expired. You can send a new one from your account settings.',
    missingTokenBody: 'No verification token found in this link.',
    goToApp: 'Go to app',
  },
  authCallbackPage: {
    title: 'Signing in with Google',
    workingTitle: 'Finishing sign-in…',
    errorTitle: 'Sign-in failed',
    errorBody: 'We could not sign you in with Google. Please try again.',
    backToLogin: 'Back to sign in',
  },
  checkoutPage: {
    title: 'Checkout',
    ...
    demoNote: "You'll be redirected to Stripe's secure checkout page to complete your order.",
    ...
    successGenericTitle: 'Thank you!',
    successGenericBody: "Your payment was accepted. Your account will update shortly.",
    ...
    secureNote: "Payment is handled by Stripe. We never store your card details.",
  },
  seo: {
    ogLocale: 'en_US',
