...
export const pl: Dictionary = {
  ...
  checkoutPage: {
    ...
    demoNote:
      'To demonstracyjny formularz płatności — żadna prawdziwa transakcja nie zostanie wykonana, a dane karty nigdzie nie są wysyłane.',
    cardholderLabel: 'Imię i nazwisko na karcie',
    cardholderPlaceholder: 'Jan Kowalski',
    cardNumberLabel: 'Numer karty',
    expiryLabel: 'Data ważności',
    cvcLabel: 'CVC',
    payButton: 'Zapłać i aktywuj',
    processingButton: 'Przetwarzanie płatności…',
